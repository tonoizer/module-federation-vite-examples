...
const RemoteApp = defineAsyncComponent(() => import("remote_a/remote-app"));
const RemoteAppC = defineAsyncComponent(() => import("remote_c/remote-app"));
</script>
...
<template>
  <div class="host">
    ...
    >
      ...
      <div style="margin-top: 10px; font-size: 25px">I'm the host app</div>
      <Counter />
    </div>
  </div>
  <Suspense>
